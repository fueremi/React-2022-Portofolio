        ...
        <div className="container">
          <div className="w-full px-4">
            <div className="max-w-xl mx-auto text-center mb-16">
              ...
              <p className="font-medium text-base text-secondary md:text-lg">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Repellendus inventore sunt blanditiis voluptas?
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full px-4 lg:w-1/2 xl:w-1/3 ">
              <div className="bg-white rounded-xl overflow-hidden shadow-lg mb-10">
                ...
                <div className="py-8 px-6">
                  ...
                  <a
                    href="#"
                    className="font-medium text-sm text-white bg-primary px-4 py-3 rounded-lg hover:opacity-80"
                  >
                    Baca Selengkapnya
                  </a>
                </div>
                ...
                <div className="py-8 px-6">
                  <h3>
                    <a
                      ...
                      className="block mb-3 font-semibold text-xl text-dark hover:text-primary truncate"
                    >
                      Tips Membeli Keyboard Mechanical
                    </a>
                  </h3>
                  <p className="font-medium text-base text-secondary mb-6">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-1/3 ">
              <div className="bg-white rounded-xl overflow-hidden shadow-lg mb-10">
                <img
                  src="https://source.unsplash.com/360x200?macbook"
                  alt="Blog-1"
                  className="w-full"
                />
                <div className="py-8 px-6">
                  <h3>
                    <a
                      ...
                      className="block mb-3 font-semibold text-xl text-dark hover:text-primary truncate"
                    >
                      Tips Macbook dengan chipset Apple Silicon
                    </a>
                  </h3>
                  <p className="font-medium text-base text-secondary mb-6">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <div className="w-full lg:w-1/2 lg:mx-auto">
              <div className="w-full px-4 mb-8">
                ...
                <input
                  type="text"
                  id="name"
                  className="w-full bg-slate-100 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary"
                />
              </div>
              <div className="w-full px-4 mb-8">
                <label
              ...
              <div className="w-full px-4 mb-8">
                ...
                <textarea
                  id="message"
                  className="w-full bg-slate-100 text-dark p-3 rounded-md focus:outline-none focus:ring-primary focus:ring-1 focus:border-primary h-32"
                ></textarea>
              </div>
              <div className="w-full px-4">
                <button className="text-base font-semibold text-white bg-primary py-3 px-8 rounded-full w-full hover:opacity-80 hover:shadow-lg transition duration-300">
                  Kirim
                </button>
              </div>
            </div>
        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
              <h2 className="font-bold text-4xl text-white mb-5">Fueremi</h2>
              <h3 className="font-bold text-2xl mb-2">Hubungi Kami</h3>
              <p>rianoktiomersaputra4@gmail</p>
              <p>Jl. TP. Sriwijaya Lr. Kemuning</p>
              <p>Jambi</p>
            </div>
          ...
          <div className="w-full pt-10 border-t border-x-slate-900">
